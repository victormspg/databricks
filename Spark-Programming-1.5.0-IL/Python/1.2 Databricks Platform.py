...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS users USING parquet LOCATION "/mnt/training/ecommerce/users/users.parquet";
# MAGIC CREATE TABLE IF NOT EXISTS sales USING parquet LOCATION "/mnt/training/ecommerce/sales/sales.parquet";
