...
# TODO
revenueDF = eventsDF.selectExpr("*", "ecommerce.purchase_revenue_in_usd AS revenue")
display(revenueDF)
...
# TODO
purchasesDF = revenueDF.where("revenue IS NOT NULL")
display(purchasesDF)
...
# TODO
finalDF = (eventsDF
  .selectExpr("*", "ecommerce.purchase_revenue_in_usd AS revenue")
